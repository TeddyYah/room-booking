                ...
                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('menu/editsubmenu/' . $sm['id_sub_menu'])  ?>"
                                    class="btn btn-sm btn-warning mr-2" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Edit">
                                    <i class="fas fa-edit"> Edit</i>
                                    <a href="<?= base_url('menu/deletesubmenu/' . $sm['id_sub_menu']) ?>"
